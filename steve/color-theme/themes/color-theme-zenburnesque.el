(defun color-theme-twilight-ruby ()
  ...
  (color-theme-install
	'(color-theme-twilight
	  ...
	  (font-lock-comment-face ((t (:foreground "#839f83"))))
	  (font-lock-constant-face ((t (:foreground "#fffbb2"))))
	  (font-lock-doc-string-face ((t (:foreground "DarkOrange"))))
	  (font-lock-function-name-face ((t (:foreground "#ff911A"))))
	  (font-lock-keyword-face ((t (:foreground "#fffbb2"))))
	  ...
	  (font-lock-string-face ((t (:foreground "#D02B23"))))
