...
(defun org-notify-action-growl (plist)
  "Send growl message."
  (growl (concat "TODO: " (plist-get plist :heading)) (org-notify-body-text plist)))

;; requires terminal-notifier gem (sudo gem install terminal-notifier)
(defun terminal-notifier (title message)
  (start-process "terminal-notifier" "notifier" "/usr/bin/terminal-notifier" "-message" message "-title" title "-activate" "org.gnu.Aquamacs"))

(defun org-notify-action-notifier (plist)
  "Send notifier message."
  (terminal-notifier (concat "TODO: " (plist-get plist :heading)) (org-notify-body-text plist)))
